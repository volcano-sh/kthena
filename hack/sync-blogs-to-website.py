...
def process_content(content, image_map, slug):
    ...
    # Extract summary (text before <!--more-->)
    summary = ""
    ...
    content = re.sub(r"import\s+LightboxImage\s+from\s+'@site/src/components/LightboxImage';\s*\n*", "", content)
    
    # Process image imports (import kthenaArchitecture from './images/kthena-arch.svg';)
    # Build a map of variable name to actual relative path
    ...
    # Replace JSX image tags with Hugo shortcodes
    ...
    # Also handle regular markdown images referring to local files
    def replace_md_images(match):
        ...
        if path.startswith('./') or path.startswith('../'):
            ...
            # Use shortcode or just markdown
...
def main():
    ...
    parser.add_argument('--target', default='../website/content/en/blog', help='Target website blog directory')
