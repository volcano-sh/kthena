...
// apply.
func AutoscalingPolicyBehavior() *AutoscalingPolicyBehaviorApplyConfiguration {
	return &AutoscalingPolicyBehaviorApplyConfiguration{}
}
...
func (b *AutoscalingPolicyBehaviorApplyConfiguration) WithScaleUp(value *AutoscalingPolicyScaleUpPolicyApplyConfiguration) *AutoscalingPolicyBehaviorApplyConfiguration {
	b.ScaleUp = value
	return b
}
