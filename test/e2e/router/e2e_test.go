...
func TestModelRouteSimple(t *testing.T) {
	...
	modelRoute := utils.LoadYAMLFromFile[networkingv1alpha1.ModelRoute]("test/e2e/testdata/kthena-router/ModelRouteSimple.yaml")
...
func TestModelRouteMultiModels(t *testing.T) {
	...
	modelRoute := utils.LoadYAMLFromFile[networkingv1alpha1.ModelRoute]("test/e2e/testdata/kthena-router/ModelRouteMultiModels.yaml")
	modelRoute.Namespace = testNamespace
	createdModelRoute, err := testCtx.KthenaClient.NetworkingV1alpha1().ModelRoutes(testNamespace).Create(ctx, modelRoute, metav1.CreateOptions{})
	require.NoError(t, err, "Failed to create ModelRoute")
	assert.NotNil(t, createdModelRoute)
...
func TestModelRoutePrefillDecodeDisaggregation(t *testing.T) {
	...
	modelServing := utils.LoadYAMLFromFile[workloadv1alpha1.ModelServing]("test/e2e/testdata/kthena-router/ModelServing-ds1.5b-pd-disaggragation.yaml")
	...
	modelServer := utils.LoadYAMLFromFile[networkingv1alpha1.ModelServer]("test/e2e/testdata/kthena-router/ModelServer-ds1.5b-pd-disaggragation.yaml")
	...
	modelRoute := utils.LoadYAMLFromFile[networkingv1alpha1.ModelRoute]("test/e2e/testdata/kthena-router/ModelRoute-ds1.5b-pd-disaggragation.yaml")
	modelRoute.Namespace = testNamespace
	createdModelRoute, err := testCtx.KthenaClient.NetworkingV1alpha1().ModelRoutes(testNamespace).Create(ctx, modelRoute, metav1.CreateOptions{})
	require.NoError(t, err, "Failed to create ModelRoute")
	assert.NotNil(t, createdModelRoute)
