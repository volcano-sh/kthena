...
func (v *ModelServingValidator) validateModelServing(modelServing *workloadv1alpha1.ModelServing) (bool, string) {
	...
	replicaErrs := validatorReplicas(modelServing)
	allErrs = append(allErrs, replicaErrs...)
...
func validGeneratedNameLength(ms *workloadv1alpha1.ModelServing) field.ErrorList {
	...
	for _, role := range ms.Spec.Template.Roles {
		name := ms.GetName() + "-" + strconv.Itoa(int(*ms.Spec.Replicas)) + "-" + role.Name + "-" + strconv.Itoa(int(*role.Replicas)) + "-" + strconv.Itoa(int(role.WorkerReplicas))
