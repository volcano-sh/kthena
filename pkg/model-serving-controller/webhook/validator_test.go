		...
		},
		{
			...
			want: field.ErrorList{
				field.Invalid(
					...
					"rolloutStrategy type Role is incompatible with recoveryPolicy type ServingGroupRecreate",
				),
			},
		},
		{
			...
			want: field.ErrorList{
				field.Invalid(
					...
					"rolloutStrategy type ServingGroup is incompatible with recoveryPolicy type RoleRecreate",
				),
			},
		},
	}
