...
// RemoveRoleReplicasForRevision removes role.replicas and role.maxUnavailable when calculating
...
// RemoveRoleReplicasForRoleTemplateHash removes role.replicas and role.maxUnavailable when
