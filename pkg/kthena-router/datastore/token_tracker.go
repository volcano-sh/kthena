...
type TokenTracker interface {
	...
	// OnRequestStart notifies the tracker that a request for user/model is
	// about to enter the fairness queue. Trackers that need to know when a user
	...
	// OnRequestStart is done: served after admission, timed out or cancelled
	// in the queue, or failed to enqueue. Every OnRequestStart call is paired
	// with exactly one OnRequestFinish call.
