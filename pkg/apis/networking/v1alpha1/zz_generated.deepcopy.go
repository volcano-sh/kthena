...
func (in *ConnectionPool) DeepCopyInto(out *ConnectionPool) {
	*out = *in
	...
	if in.MaxIdleConnectionsPerHost != nil {
		in, out := &in.MaxIdleConnectionsPerHost, &out.MaxIdleConnectionsPerHost
		*out = new(int32)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SessionKeySource) DeepCopyInto(out *SessionKeySource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionKeySource.
func (in *SessionKeySource) DeepCopy() *SessionKeySource {
	if in == nil {
		return nil
	}
	out := new(SessionKeySource)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SessionSticky) DeepCopyInto(out *SessionSticky) {
	*out = *in
	if in.SessionAffinitySeconds != nil {
		in, out := &in.SessionAffinitySeconds, &out.SessionAffinitySeconds
		*out = new(int32)
		**out = **in
	}
	if in.Sources != nil {
		in, out := &in.Sources, &out.Sources
		*out = make([]SessionKeySource, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SessionSticky.
func (in *SessionSticky) DeepCopy() *SessionSticky {
	if in == nil {
		return nil
	}
	out := new(SessionSticky)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TrafficPolicy) DeepCopyInto(out *TrafficPolicy) {
	*out = *in
	...
	if in.SessionSticky != nil {
		in, out := &in.SessionSticky, &out.SessionSticky
		*out = new(SessionSticky)
		(*in).DeepCopyInto(*out)
	}
}
