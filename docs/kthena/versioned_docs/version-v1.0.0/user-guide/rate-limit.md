...
# 5. Clean up
kubectl delete -f https://github.com/volcano-sh/kthena/blob/main/examples/kthena-router/scenarios/local-rate-limit/ModelRouteWithRateLimit.yaml
```
...
kubectl apply -f https://github.com/volcano-sh/kthena/blob/main/examples/kthena-router/scenarios/global-rate-limit/ModelRouteWithGlobalRateLimit.yaml
...
# 6. Clean up
kubectl delete -f https://github.com/volcano-sh/kthena/blob/main/examples/kthena-router/scenarios/global-rate-limit/ModelRouteWithGlobalRateLimit.yaml
```
